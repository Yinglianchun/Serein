...
from pydantic import BaseModel, Field, ConfigDict, StrictBool, BeforeValidator, field_validator, model_validator
...
SceneCues = Annotated[list[Annotated[str, Field(min_length=1, max_length=80)]], Field(min_length=1, max_length=8), BeforeValidator(Scenes._cues)]
...
class Draft(InputModel):
    ...
    cues: SceneCues = Field(description="1..8 short recall cues, each at most 80 characters")
